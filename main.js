...
//일찍 보도록 앞당기는 값을 담은 변수 (디테일을 맞추기 위해 해당 값은 상황에 따라 바꿔주세용)
...
window.addEventListener("scroll", () => {
  ...
  //스크롤의 값을 연동해서 두번째 섹션안에있는 p태그의 left의 값을
  //변경하도록 하는 코드입니다
  // scroll은 계속늘어나는 큰값, 여기에 해당 section의 offsetOP을 빼주어야
  //연동할수있는 작은 값이 되기 때문에 빼줍니다
  //300은 디테일한 움직임을 조절하는 값입니다 (필요할 때마다 바꿔주세용)
